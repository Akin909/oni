...
import { IMessageEvent } from "./"
import * as SyntaxHighlighting from "./../Services/SyntaxHighlighting/SyntaxHighlightingStore"
import * as Selectors from "./../Services/SyntaxHighlighting/SyntaxHighlightSelectors"
...
export class SyntaxHighlightingPeriodicJob implements IPeriodicJob {
    ...
    public onMessage({ data }: IMessageEvent) {
        if (data instanceof Object && this[data.method]) {

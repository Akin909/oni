...
sessionManager.persist = function(name_of_session)
  local sessionOpt = nvim.nvim_get_option("sessionoptions")
...
sessionManager.delete = function(name_of_session)
  os.remove(default_dir .. name_of_session)
end

sessionManager.rename = function(name_of_session, new_name)
  os.rename(default_dir .. name_of_session, default_dir .. new_name)
end
